...
def data_input_main():
	...
	try:
		...
		yst_main(yesterday)
		with open(r"D:\uploadTempFiles\python\logFile\log.txt","a") as f:
			f.write("----  "+str(datetime.now())+" yst finish!  ----\n")
	except Exception as e:
		with open(r"D:\uploadTempFiles\python\logFile\log.txt","a") as f:
			f.write(str(e)+'\n')
	...
	try:
		...
		print("----  "+str(datetime.now())+" report finish!  ----\n")
		with open(r"D:\uploadTempFiles\python\logFile\log.txt","a") as f:
			f.write("----  "+str(datetime.now())+" report finish!  ----\n")
	except Exception as e:
		with open(r"D:\uploadTempFiles\python\logFile\log.txt","a") as f:
			f.write(str(e)+'\n')
